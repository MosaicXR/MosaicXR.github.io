...
const stereoOption = document.getElementById("stereoOption"); // Stereo option checkbox reference
      ...
      reader.onload = function (e) {
        ...
        imgElement.addEventListener("click", function () {
          ...
          setTimeout(() => {
            ...
            base64Images = base64Images.filter(
              (base64) => base64 !== e.target.result.split(",")[1]
            );
...
uploadButton.addEventListener("click", function () {
  ...
  const uploadUrl = stereoOption.checked
    ? "https://kite-prompt-koi.ngrok-free.app/images/upload-multiple-stereo"
    : "https://kite-prompt-koi.ngrok-free.app/images/upload-multiple";

  // Send the base64 strings to the URL
  fetch(uploadUrl, {
    method: "POST",
    headers: {
